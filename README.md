...
const: block scoped, Can't be updated or redeclared, value must be assigned when declared


2️⃣ What is the spread operator (...)?

Ans: spread operator is used to expand elements of an array or object into individual elements
...
forEach(): looping through elements and returns nothing


4️⃣ What is an arrow function?

Ans: Arrow function is a shorter syntax for writing functions in JS ES6


5️⃣ What are template literals?

Ans: Template literals allow to insert varibles inside strings using bakticks() and ${}
