...
const createElements = (arr) =>{
    const htmlElements = arr.map((el) => `<span class="badge badge-outline font-medium text-[10px]">${el}</span>`);
...
<h2 id="modalTitle" class="font-bold text-[24px]">${issue.title}</h2>
            ...
            <div class="flex items-center gap-2">
                <span id="modalStatus"
                    class="badge badge-outline text-white text-[blue] font-medium text-[10px]">${issue.status}</span>
            ...
            <div class="flex items-center gap-[150px] bg-gray-100 p-2 rounded-xl">
                <p>Assignee:<br><span id="modalAssignee" class="font-semibold">${issue.assignee ? issue.assignee : "Assignee not found"}</span></p>
